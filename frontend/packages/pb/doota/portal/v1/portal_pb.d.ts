...
import type { AugmentedPost, PostSchema, PostSettingsSchema, SchedulePostRequestSchema } from "../../core/v1/post_pb";
...
export declare type GetPostsResponse = Message<"doota.portal.v1.GetPostsResponse"> & {
  /**
   * @generated from field: repeated doota.core.v1.AugmentedPost posts = 1;
   */
  posts: AugmentedPost[];
};
