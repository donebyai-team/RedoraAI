...
import { MessageSquare, Search, Send, ArrowUp } from "lucide-react";
      ...
      <Card className="border-primary/10 shadow-md bg-gradient-to-br from-background to-secondary/30">
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-muted-foreground">Posts Tracked Today</p>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold">0.82</h3>
            </div>
            <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
