...
type PortalServiceClient interface {
	...
	CreateKeyword(context.Context, *connect.Request[v1.CreateKeywordReq]) (*connect.Response[v1.CreateKeywordRes], error)
}
...
func NewPortalServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PortalServiceClient {
	...
	return &portalServiceClient{
		...
		createKeyword: connect.NewClient[v1.CreateKeywordReq, v1.CreateKeywordRes](
			httpClient,
...
type portalServiceClient struct {
	...
	createKeyword      *connect.Client[v1.CreateKeywordReq, v1.CreateKeywordRes]
}
...
func (c *portalServiceClient) CreateKeyword(ctx context.Context, req *connect.Request[v1.CreateKeywordReq]) (*connect.Response[v1.CreateKeywordRes], error) {
...
func (UnimplementedPortalServiceHandler) CreateKeyword(context.Context, *connect.Request[v1.CreateKeywordReq]) (*connect.Response[v1.CreateKeywordRes], error) {
