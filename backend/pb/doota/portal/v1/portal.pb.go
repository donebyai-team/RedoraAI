...
func (x *BatchReq) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
var file_doota_portal_v1_portal_proto_rawDesc = []byte{
	...
	0x08, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c,
	0x65, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x66, 0x69, 0x6c,
	0x65, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x73, 0x76, 0x5f, 0x64, 0x61, 0x74,
	...
	0x65, 0x64, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x82, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x6d, 0x61, 0x69, 0x6c, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x2d, 0x0a, 0x04,
	0x72, 0x6f, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x64, 0x6f, 0x6f,
	0x74, 0x61, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x43, 0x0a, 0x0d, 0x6f,
	...
	0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x3a, 0x0a, 0x03, 0x4a,
	...
	0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x2a, 0x6c, 0x0a, 0x08,
	...
	0x4b, 0x45, 0x44, 0x10, 0x02, 0x32, 0xde, 0x01, 0x0a, 0x0d, 0x50, 0x6f, 0x72, 0x74, 0x61, 0x6c,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x35, 0x0a, 0x04, 0x53, 0x65, 0x6c, 0x66, 0x12,
	...
	0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_doota_portal_v1_portal_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_doota_portal_v1_portal_proto_goTypes = []interface{}{
	...
	(*BatchReq)(nil),                 // 3: doota.portal.v1.BatchReq
	(*BatchResp)(nil),                // 4: doota.portal.v1.BatchResp
	(*User)(nil),                     // 5: doota.portal.v1.User
	(*JWT)(nil),                      // 6: doota.portal.v1.JWT
	(*Organization)(nil),             // 7: doota.portal.v1.Organization
	(*OrganizationFeatureFlags)(nil), // 8: doota.portal.v1.OrganizationFeatureFlags
	(*Integration)(nil),              // 9: doota.portal.v1.Integration
	(*GetIntegrationRequest)(nil),    // 10: doota.portal.v1.GetIntegrationRequest
...
var file_doota_portal_v1_portal_proto_depIdxs = []int32{
	...
	7,  // 1: doota.portal.v1.User.organizations:type_name -> doota.portal.v1.Organization
	11, // 2: doota.portal.v1.User.created_at:type_name -> google.protobuf.Timestamp
	8,  // 3: doota.portal.v1.Organization.feature_flags:type_name -> doota.portal.v1.OrganizationFeatureFlags
	11, // 4: doota.portal.v1.Organization.created_at:type_name -> google.protobuf.Timestamp
	...
	12, // 8: doota.portal.v1.PortalService.Self:input_type -> google.protobuf.Empty
	10, // 9: doota.portal.v1.PortalService.GetIntegration:input_type -> doota.portal.v1.GetIntegrationRequest
	3,  // 10: doota.portal.v1.PortalService.Batch:input_type -> doota.portal.v1.BatchReq
	5,  // 11: doota.portal.v1.PortalService.Self:output_type -> doota.portal.v1.User
	9,  // 12: doota.portal.v1.PortalService.GetIntegration:output_type -> doota.portal.v1.Integration
	4,  // 13: doota.portal.v1.PortalService.Batch:output_type -> doota.portal.v1.BatchResp
